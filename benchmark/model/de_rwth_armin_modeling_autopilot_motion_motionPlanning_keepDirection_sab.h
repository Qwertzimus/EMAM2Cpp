#ifndef DE_RWTH_ARMIN_MODELING_AUTOPILOT_MOTION_MOTIONPLANNING_KEEPDIRECTION_SAB
#define DE_RWTH_ARMIN_MODELING_AUTOPILOT_MOTION_MOTIONPLANNING_KEEPDIRECTION_SAB
#ifndef M_PI
...
class de_rwth_armin_modeling_autopilot_motion_motionPlanning_keepDirection_sab{
public:
double v1x;
double v1y;
double v2x;
