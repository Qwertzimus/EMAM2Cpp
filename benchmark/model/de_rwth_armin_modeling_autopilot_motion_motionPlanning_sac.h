#ifndef DE_RWTH_ARMIN_MODELING_AUTOPILOT_MOTION_MOTIONPLANNING_SAC
#define DE_RWTH_ARMIN_MODELING_AUTOPILOT_MOTION_MOTIONPLANNING_SAC
#ifndef M_PI
...
class de_rwth_armin_modeling_autopilot_motion_motionPlanning_sac{
public:
